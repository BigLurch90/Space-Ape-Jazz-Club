...
<?php get_header(); ?>
        ...
        <div class="live">
            ...
            <div class="live__inner">
                ...
                <h2 class="live__title"><?php the_field('live_title'); ?></h2>
                <p class="live__text"><?php the_field('live_text'); ?></p>
                <div>

                    <?php 

                        $live_button = get_field('live_button');
                        $live_button_link = get_field('live_link');

                    ?>

                    <?php if( $live_button ) : ?>
                    <button class="live__button">
                        <a href="<?php echo $live_button_link ?>"><?php echo $live_button ?></a>
                    </button>
                    <?php endif; ?>
                </div>
        ...
        <div class="about">
            ...
            <div class="about__inner">
                ...
                <section class="about__content">
                    <h3 class="about__title"><?php the_field('about_main_title'); ?></h3>
                    <p><?php the_field('about_text_one'); ?></p>
                    <h3 class="about__under-title"><?php the_field('about_secondary_title'); ?></h3>
                ...
                <?php 
                    ...
                    if (get_field('about_image')) {
                        ...
                        $url = get_template_directory_uri() . './assets/image/about-image.png';
