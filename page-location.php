<?php // Template Name: Locationpage ?>
...
<?php get_header(); ?>
        ...
        <div class="location-header__inner">
            ...
            <div class="location-header__content">
                <a href="<?php echo 'http://space-ape-jazz-club.local'?>" class="location-header__logo">
                ...
                <h1 class="location-header__title">Location</h1>
            </div>
        ...
        <div class="location-hero">
            ...
            <div class="location-hero__inner">
                ...
                <div class="location-hero__content">
                    <h1><?php the_field('location_title'); ?></h1>
                    <p><?php the_field('location_text'); ?></p>
                </div>

                <figure class="location-hero__image">
                    <img src="<?php echo get_template_directory_uri(); ?>./assets/image/Mask Group 16.png" alt="">
                </figure>
