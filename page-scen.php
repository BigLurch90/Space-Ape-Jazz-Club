<?php // Template Name: Scenpage ?>


<?php get_header(); ?>

        <header class="scen-header">

            <div class="scen-header__inner">

                <!-- Logo -->
                <div class="scen-header__content">
                    <a href="<?php echo 'http://space-ape-jazz-club.local'?>" class="scen-header__logo">
                    ...
                    <h1 class="scen-header__title">Scen</h1>
                </div>
        ...
        <!-- Scen Hero -->
        <section class="scen-hero">

            <div class="scen-hero__inner">
                <div class="scen-hero__content">
                    <p><?php the_field('main_text_scen'); ?></p>
                </div>
                
                <?php 
                
                    if (get_field('scen_hero_image')) {

                        $image = get_field('scen_hero_image');
                        $url = $image['url'];


                    } else {

                        $url = get_template_directory_uri() . './assets/image/scen-backgraund.png".png';

                    }

                ?>

                <figure class="scen-hero__backgraund">
        ...
        <section class="performance">
            <div class="performance__inner">
                <div class="performance__content">
                    <h2><?php the_field('performances_title'); ?></h2>
                    <p><?php the_field('performances_text'); ?></p>
                </div>

                <?php 
                
                    if (get_field('scen_performances_image')) {

                        $image = get_field('scen_performances_image');
                        $url = $image['url'];


                    } else {

                        $url = get_template_directory_uri() . './assets/image/live-performance-img.png';
        ...
        <section class="schedule">
            <div class="schedule__inner">
                ...
                <?php 
                    ...
                    if (get_field('scen_schedule_image')) {

                        $image = get_field('scen_schedule_image');
                        $url = $image['url'];


                    } else {

                        $url = get_template_directory_uri() . './assets/image/schedule-image.png';

                    }

                ?>

                <figure class="schedule__image">
                    <img src="<?php echo $url; ?>" alt="">
                </figure>

                <nav class="schedule__content">
                    <h3>Live schedule:</h3>
                    <h4>Wednesday:</h4>
                    <?php the_field('wednesday_band'); ?>
                    <h4>Friday:</h4>
                    <?php the_field('friday_band'); ?>
                    <h4>Saturday:</h4>
                    <?php the_field('saturday_band'); ?>
        ...
        <!-- Performance form -->
        <section class="intrest-form">

            <div class="intrest-form__inner">
            
                <div class="intrest-form__content">
                    <h3><?php the_field('form_title'); ?></h3>
                    <p><?php the_field('form_text'); ?></p>
                </div>

                <form action="" class="form">
                    <h4 class="form__title">Intrest form:</h4>
                    <?php echo do_shortcode( '[contact-form-7 id="ceedb02" title="Contact-form"]' ) ?>
                </form>
